 ...
 *
 * @namespace Alvex
 * @class Alvex.ProjectConversations
 */
(function()
{
	/**
	...
	*/
	...
	/**
	* Dashboard ProjectConversations constructor.
	*
	* @param {String} htmlId The HTML id of the parent element
	* @return {Alvex.ProjectConversations} The new component instance
	* @constructor
	*/
	Alvex.ProjectConversations = function ProjectConversations_constructor(htmlId)
	{
		Alvex.ProjectConversations.superclass.constructor.call(this, "Alvex.ProjectConversations", htmlId, 
	...
	*/
	YAHOO.extend(Alvex.ProjectConversations, Alfresco.component.Base);

	/**
	* Augment prototype with main class implementation, ensuring overwrite is enabled
	*/
	YAHOO.lang.augmentObject(Alvex.ProjectConversations.prototype,
	{
		/**
		...
		* @method onReady
		*/
		onReady: function ProjectConversations_onReady()
		{
			var me = this;
			...
			var url = Alfresco.constants.PROXY_URI + YAHOO.lang.substitute("api/alvex/project/{projectId}/conversations",
			{
		...
		onDeleteItem: function(item)
		{
			...
			Alfresco.util.PopupManager.displayPrompt(
			{
				...
				buttons: [
				{
					...
					handler: function()
					{
						var deleteUrl = Alfresco.constants.PROXY_URI + 'api/alvex/project/conversation/' 
		...
		*/
		renderCellIcon: function ProjectConversations_onReady_renderCellIcons(elCell, oRecord, oColumn, oData)
		{
		...
		*/
		renderCellInfo: function ProjectConversations_onReady_renderCellTaskInfo(elCell, oRecord, oColumn, oData)
		{
			var data = oRecord.getData();
			if (data.isInfo)
			{
		...
		*/
		renderCellActions:function ProjectConversations_onReady_renderCellActions(elCell, oRecord, oColumn, oData)
		{
			var data = oRecord.getData();
			if (data.isInfo)
			{
			...
			var clb = 'onViewItem';
			desc += '<div class="' + clb + '">' 
					+ '<a href="" ' + 'class="alvex-project-conversations-action '+ this.id + '-action-link" ' 
