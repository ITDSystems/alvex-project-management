...
(function()
{
	...
	*/
	...
	/**
	* Dashboard ProjectChecklists constructor.
	*
	* @param {String} htmlId The HTML id of the parent element
	* @return {Alvex.ProjectChecklists} The new component instance
	* @constructor
	*/
	Alvex.ProjectChecklists = function ProjectChecklists_constructor(htmlId)
	{
		Alvex.ProjectChecklists.superclass.constructor.call(this, "Alvex.ProjectChecklists", htmlId, 
	...
	*/
	YAHOO.extend(Alvex.ProjectChecklists, Alfresco.component.Base);

	/**
	* Augment prototype with main class implementation, ensuring overwrite is enabled
	*/
	YAHOO.lang.augmentObject(Alvex.ProjectChecklists.prototype,
	{
		/**
		...
		* @method onReady
		*/
		onReady: function ProjectChecklists_onReady()
		{
			var me = this;
			Alfresco.util.Ajax.jsonGet(
			{
				url: Alfresco.constants.PROXY_URI + "api/alvex/project/" + encodeURIComponent(Alfresco.constants.SITE) + "/checklists/container",
				successCallback:
				{
					fn: function(resp)
					{
			...
			var url = Alfresco.constants.PROXY_URI + YAHOO.lang.substitute("api/alvex/project/{projectId}/checklists",
			{
		...
		onDeleteItem: function(item)
		{
			...
			Alfresco.util.PopupManager.displayPrompt(
			{
				...
				buttons: [
				{
					...
					handler: function()
					{
						var deleteUrl = Alfresco.constants.PROXY_URI + 'api/alvex/project/checklist/' 
		...
		*/
		renderCellIcon: function ProjectChecklists_onReady_renderCellIcons(elCell, oRecord, oColumn, oData)
		{
		...
		*/
		renderCellInfo: function ProjectChecklists_onReady_renderCellTaskInfo(elCell, oRecord, oColumn, oData)
		{
			var data = oRecord.getData();
			if (data.isInfo)
			{
		...
		*/
		renderCellActions:function ProjectChecklists_onReady_renderCellActions(elCell, oRecord, oColumn, oData)
		{
			var data = oRecord.getData();
			if (data.isInfo)
			{
			...
			var clb = 'onViewItem';
			desc += '<div class="' + clb + '">' 
					+ '<a href="" ' + 'class="alvex-project-checklists-action '+ this.id + '-action-link" ' 
