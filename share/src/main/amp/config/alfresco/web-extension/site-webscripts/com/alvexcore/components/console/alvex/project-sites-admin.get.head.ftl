...
<@script type="text/javascript" src="${page.url.context}/res/js/components/alvex-create-site.js" />
<@script type="text/javascript" src="${page.url.context}/res/js/components/alvex-manage-sites.js" />
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/css/components/alvex-manage-sites.css" />
