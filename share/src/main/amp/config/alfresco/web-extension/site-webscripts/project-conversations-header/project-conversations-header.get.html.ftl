<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${url.context}/res/css/components/alvex/project-conversations-header.css" group="workflow"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${url.context}/res/js/components/alvex/project-conversations-header.js" group="workflow"/>
   <@script src="${url.context}/res/js/components/alvex.js" group="workflow"/>
