...
public class WorkflowInstancesForNodeGet extends AbstractWorkflowWebscript
{
    ...
    protected Map<String, Object> buildModel(WorkflowModelBuilder modelBuilder, WebScriptRequest req, Status status, Cache cache)
    {
        ...
        List<Map<String, Object>> completedResults = new ArrayList<Map<String, Object>>(completedWorkflows.size());
        
        for (WorkflowInstance workflow : completedWorkflows)
        {
            completedResults.add(modelBuilder.buildSimple(workflow));
        }

        Map<String, Object> model = new HashMap<String, Object>();
        // build the model for ftl
        model.put("activeWorkflowInstances", results);
        model.put("completedWorkflowInstances", completedResults);
